    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (requestedAction == null) {
            ...
            try {
                ...
                session.setAttribute("books", books);               // Error 2: When fetching books list, all others using "books" instead of "Books"
            ...
            if (cart == null) {
                ...
                for (String isbn : selectedBooks) {
                    ...
                    if (cart.containsKey(isbn)) {
                        ...
                        Book book = this.getBookFromList(isbn, session);    // Error 1: Class name "Book" instead of "Books"
                        CartItem item = new CartItem(book);
                        item.setQuantity(quantity);
                        cart.put(isbn, item);
                    }
